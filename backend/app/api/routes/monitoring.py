...
def get_program_performance(
    ...
    return service.get_program_performance(session)
...
def get_geographic_performance(
    ...
    return service.get_geographic_performance(session)
...
def get_data_quality_summary(
    ...
    return service.get_data_quality_summary(session)
...
def get_data_quality_issue_breakdown(
    ...
    return service.get_data_quality_issue_breakdown(session)